                    ...
                    <div v-for="item in tableData" class="list-wrap clearfix">
                        <div class="header clearfix">
                            ...
                            <div class="right">
                                ...
                                <div class="price-wrap">当前合计{{item.actual_price}}元（未含运费）</div>
                            </div>
                        </div>
        ...
        <el-dialog title="打印快递单" :visible.sync="dialogFormVisible">
            <el-form :model="dform">
                ...
                <el-form-item label="要在快递单上打印单发货内容" v-if="isShow">
                    <el-input type="textarea" v-model="receiver.name" @blur="changeInfo(orderInfo)"
                              placeholder="收件人名字"></el-input>
                    <el-input type="textarea" v-model="receiver.mobile" @blur="changeInfo(orderInfo)"
                              placeholder="收件人手机"></el-input>
                    <el-input type="textarea" v-model="receiver.address" @blur="changeInfo(orderInfo)"
                              placeholder="收件人地址"></el-input>           
