    ...
    <div class="content-page">
        <div class="content-nav">
            ...
            <div class="operation-nav">
                ...
                <el-button type="primary" onclick="window.print()" size="small" icon="arrow-left">打印</el-button>
        ...
        <div class="content-main">
            <div class="form-table-box" id="section-to-print">
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="订单信息" name="first">
                        ...
                        <div class="detail-wrap">
                            ...
                            <div class="total-price"> 合计：¥{{infoForm.actual_price}}（未含运费）</div>
                            <div class="total-price"> 改价前：¥{{infoForm.change_price}}（未含运费）</div>
